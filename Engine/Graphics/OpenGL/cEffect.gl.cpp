...
// constructor
eae6320::Graphics::Effect::Effect() : m_vertexShader(nullptr), m_fragmentShader(nullptr), m_programId(0){
}
...
eae6320::cResult eae6320::Graphics::Effect::InitializeShadingData(std::string i_vertexShaderPath, std::string i_fragmentShaderPath, uint8_t i_renderStateBits) {
	...
	auto result = InitializeShaders(i_vertexShaderPath, i_fragmentShaderPath, i_renderStateBits);
