...
namespace eae6320
{
	...
	private:
		...
		const char* GetMainWindowClassName() const final { return "Anna's Example Main Window Class"; }
		...
		eae6320::cResult eae6320::cFinalGame::SendVisibility(bool i_exitCode);
	};
}
